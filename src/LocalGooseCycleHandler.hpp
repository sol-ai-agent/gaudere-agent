#ifndef GAUDERE_AGENT_LOCAL_GOOSE_CYCLE_HANDLER_HPP
#define GAUDERE_AGENT_LOCAL_GOOSE_CYCLE_HANDLER_HPP
...
class LocalGooseCycleHandler final : public TaskHandler {
public:
    LocalGooseCycleHandler(LocalGooseRunner& runner,
                           std::string model_id,
